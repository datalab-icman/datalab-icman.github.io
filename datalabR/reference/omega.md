...
- alpha:
  ...
  A square real-valued numeric matrix or cone generator matrix.
...
The Genz-Bretz algorithm has the following characteristics:

- Implements Quasi-Monte Carlo integration with Halton sequences.

- Uses importance sampling to reduce variance.

- Provides an adaptive subdivision for high-dimensional integrals.

- Estimates error via repeated evaluations.
...
Heidelberg. <https://doi.org/10.1007/978-3-642-01689-9>

Ribando, J. M. (2006). Measuring solid angles beyond dimension three.
*Discrete & Computational Geometry*, **36**(3), 479-487.
<https://doi.org/10.1007/s00454-006-1253-4>

## See also

`compute_solid_angle` for alternative methods including hypergeometric
series and decomposition approaches.
